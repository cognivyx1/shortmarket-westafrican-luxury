...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "One40vue" },
      { name: "description", content: "ONE40vue | West African restaurant and bar in Cape Town." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "One40vue" },
      { property: "og:description", content: "ONE40vue | West African restaurant and bar in Cape Town." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "One40vue" },
      { name: "twitter:description", content: "ONE40vue | West African restaurant and bar in Cape Town." },
