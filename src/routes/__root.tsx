...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "One40vue" },
      { name: "description", content: "ONE40vue Elegance is a premium one-page website for a West African restaurant and bar in Cape Town." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "One40vue" },
      { property: "og:description", content: "ONE40vue Elegance is a premium one-page website for a West African restaurant and bar in Cape Town." },
